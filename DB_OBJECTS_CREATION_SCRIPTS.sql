...
VALUES (PAYMENT_SEQ.NEXTVAL, 666001, TO_DATE('2023-12-01', 'YYYY-MM-DD'), 50);

INSERT INTO PAYMENT (pay_id, sub_id, transaction_date, amount)
VALUES (PAYMENT_SEQ.NEXTVAL, 666002, TO_DATE('2023-12-01', 'YYYY-MM-DD'), 180);

INSERT INTO PAYMENT (pay_id, sub_id, transaction_date, amount)
VALUES (PAYMENT_SEQ.NEXTVAL, 666003, TO_DATE('2023-12-01', 'YYYY-MM-DD'), 50);

INSERT INTO PAYMENT (pay_id, sub_id, transaction_date, amount)
VALUES (PAYMENT_SEQ.NEXTVAL, 666004, TO_DATE('2023-12-03', 'YYYY-MM-DD'), 180);

INSERT INTO PAYMENT (pay_id, sub_id, transaction_date, amount)
VALUES (PAYMENT_SEQ.NEXTVAL, 666005, TO_DATE('2023-12-05', 'YYYY-MM-DD'), 180);
...
VALUES (booking_seq.NEXTVAL, 555001, 666001, 444001, TO_DATE('2023-12-05', 'YYYY-MM-DD'), 'AFTERNOON', 333001, 'N');

INSERT INTO BOOKING (book_id, c_id, sub_id, meal_id, BOOKING_DATE, DATE_OF_DELIVERY, time_slot, dp_id, is_delivered)
VALUES (booking_seq.NEXTVAL, 555002, 666002, 444002, TO_DATE('2023-12-05', 'YYYY-MM-DD'), TO_DATE('2023-02-15', 'YYYY-MM-DD'), 'NIGHT', 333002, 'Y');

INSERT INTO BOOKING (book_id, c_id, sub_id, meal_id, BOOKING_DATE, DATE_OF_DELIVERY, time_slot, dp_id, is_delivered)
VALUES (booking_seq.NEXTVAL, 555003, 666003, 444003, TO_DATE('2023-12-05', 'YYYY-MM-DD'), TO_DATE('2023-03-27', 'YYYY-MM-DD'), 'AFTERNOON', 333001, 'N');
...
INSERT INTO BOOKING (book_id, c_id, sub_id, meal_id, BOOKING_DATE, DATE_OF_DELIVERY, time_slot, dp_id, is_delivered)
VALUES (booking_seq.NEXTVAL, 555005, 666005, 444001, TO_DATE('2023-12-05', 'YYYY-MM-DD'), TO_DATE('2023-05-23', 'YYYY-MM-DD'), 'AFTERNOON', 333001, 'N');
/
